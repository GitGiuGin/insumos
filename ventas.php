        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-primary active" href="ventas.php">Ventas</a>
                    </li>
                    <li class="nav-item">
...
<body>
    ...
    <div class="container mt-5">
            ...
            <tbody>
                ...
                if ($resultado->num_rows > 0) {
                    while ($fila = $resultado->fetch_assoc()) {
                        ...
                        echo "<td><a href='editar_venta.php?id=" . $fila['id'] . "'>Editar</a></td>";
                        echo "<td><a href='eliminar_venta.php?id=" . $fila['id'] . "'>Eliminar</a></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='8'>No se encontraron ventas en la base de datos.</td></tr>";
                }
                // Cerrar la conexión
                $conexion->close();
                ?>
        ...
        <div class="d-flex justify-content-end">
            <a href="registrar_venta.php" class="btn btn-success btn-add-product">Registrar Venta</a>
        </div>
    </div>
</body>
<!-- Footer -->
