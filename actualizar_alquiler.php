    ...
    <script>
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            document.getElementById('fecha_inicio').addEventListener('change', (e) => {
                ...
                document.getElementById('fecha_fin').setAttribute('min', startDate);
            });

            document.getElementById('fecha_fin').addEventListener('change', (e) => {
                const endDate = e.target.value;
                document.getElementById('fecha_limite').value = endDate;
            });
        });
    </script>
</head>
        ...
        <form action="registrar_alquiler.php" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha_limite" name="fecha_limite" readonly>
                </div>
            </div>
