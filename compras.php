...
<body>
    ...
    <div class="container mt-5">
        <form class="d-flex" action="buscar.php" method="GET">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="proveedor" id="proveedor" value="proveedor">
                <label class="form-check-label" for="categoria1">Proveedor</label>
            </div>
            <div class="form-check form-check-inline">
    ...
    <div class="container mt-5">
            ...
            <tbody>
                ...
                if ($resultado->num_rows > 0) {
                    while ($fila = $resultado->fetch_assoc()) {
                        ...
                        echo "<td><a href='editar_compra.php?id=" . $fila['id'] . "'>Editar</a></td>";
                        echo "<td><a href='eliminar_compra.php?id=" . $fila['id'] . "'>Eliminar</a></td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='8'>No se encontraron compras en la base de datos.</td></tr>";
                }
                // Cerrar la conexión
                $conexion->close();
                ?>
        ...
        <div class="d-flex justify-content-end">
            <a href="registrar_compra.php" class="btn btn-success btn-add-product">Registrar Compra</a>
        </div>
    </div>
</body>
<!-- Footer -->
